...
2. `Biomass_core`is cloned in the submodules folder. When `Biomass_yieldTables` is ran in a project with `Biomass_speciesFactorial` (which also clone `Biomass_core`) and/or `Biomass_core` it shouldn't be necessary to clone it again.
